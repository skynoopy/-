...
bp = Blueprint('web_create_host', __name__)
...
def requesturl(uhostname, uhostcpu, uhostmem, uhostdisk, uhostzone, uhostvpc, uhostnetid, uhostsystem):
    requrl = {
...
#
#         requesturl(uhostname, uhostcpu, uhostmem, uhostdisk)
#         return "hostname:{},cpu:{},mem:{},disk:{}".format(uhostname, uhostcpu, uhostmem, uhostdisk)
#         dt = dingtalk()
#         return "200"
#
#     else:
